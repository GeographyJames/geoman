...
impl Insert for (ProjectCollectionInputDto, UserId) {
    ...
    {
        let (collection, user_id) = self;
        sqlx::query_scalar!(
            r#"INSERT INTO app.collections (title, description, geometry_type, added_by, last_updated_by)
            VALUES ($1, $2, $3, $4, $4) RETURNING id AS "id: ProjectCollectionId""#,
            collection.title,
