...
pub fn project_features_routes(cfg: &mut web::ServiceConfig) {
    cfg.service(
        scope(&URLS.api.project_features)
            ...
            .service(get_project_feature_download)
...
pub fn layer_styles_routes(cfg: &mut web::ServiceConfig) {
    cfg.service(scope(&URLS.api.layer_styles).service(get_layer_styles));
}
