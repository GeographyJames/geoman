...
use crate::{
    AuthenticatedUser, errors::ApiError, features::data_providers::types::DataProviderLayerId,
...
pub async fn delete_data_provider_layer(
    ...
    repo.delete_data_provider_layer(id.into_inner()).await?;
...
mod tests {
    ...
    #[actix_web::test]
    async fn delete_data_provider_layer_requires_admin_permission() {
        let req = test::TestRequest::delete().uri("/1");
        let resp = mock_app_with_path_params(
            delete_data_provider_layer,
            req,
