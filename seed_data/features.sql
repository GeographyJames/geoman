...
(
    ...
    '{"site_type": "Development", "status": "Active"}',
    0, 0,
    true,
    ...
    '{"site_type": "Construction", "status": "Active"}',
    0, 0,
    false,
    ...
    '{"site_type": "Industrial", "status": "Active"}',
    0, 0,
    false,
    ...
    '{"site_type": "Business Park", "status": "Planning"}',
    0, 0,
    false,
...
(
    ...
    'Pennine Way Section',
    '{"track_type": "Hiking Trail", "difficulty": "Moderate", "surface": "Gravel"}',
    0, 0,
    true,
    ...
    (SELECT id FROM app.collections WHERE title = 'access tracks'),
    'Farm Access Road',
    '{"track_type": "Access Road", "surface": "Dirt", "width_m": 3.5}',
    0, 0,
    false,
    ...
    '{"track_type": "Coastal Path", "difficulty": "Easy", "surface": "Paved"}',
    0, 0,
    false,
    ...
    (SELECT id FROM app.collections WHERE title = 'access tracks'),
    'Mountain Bike Trail',
    '{"track_type": "Mountain Bike", "difficulty": "Hard", "surface": "Natural"}',
    0, 0,
    false,
    ...
    (SELECT id FROM app.collections WHERE title = 'access tracks'),
    'Service Track',
    '{"track_type": "Service Road", "surface": "Gravel", "width_m": 4.0}',
    0, 0,
    false,
...
(
    ...
    '{"cable_type": "Fiber Optic", "capacity_gbps": 100, "owner": "BT", "depth_m": 1.2}',
    0, 0,
    true,
    ...
    '{"cable_type": "Electrical", "voltage_kv": 11, "owner": "National Grid", "depth_m": 0.8}',
    0, 0,
    false,
    ...
    '{"cable_type": "Copper", "owner": "Virgin Media", "depth_m": 0.6}',
    0, 0,
    false,
    ...
    '{"cable_type": "Fiber Optic", "capacity_gbps": 400, "owner": "BT", "depth_m": 1.5}',
    0, 0,
    false,
    ...
    '{"cable_type": "Electrical", "voltage_kv": 0.4, "owner": "UK Power Networks", "depth_m": 0.5}',
    0, 0,
    false,
    ...
    '{"cable_type": "Fiber Optic", "capacity_gbps": 1000, "owner": "Equinix", "depth_m": 2.0}',
    0, 0,
    false,
